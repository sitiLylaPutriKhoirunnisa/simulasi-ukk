...
<div class="container-fluid">
    ...
    <input type="hidden" name="id_spp" class="form-control" id="exampleInputPassword1" value="<?php echo $_GET ['id_spp']?>">
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="nominal" class="form-control" id="exampleInputPassword1">
  </div>
