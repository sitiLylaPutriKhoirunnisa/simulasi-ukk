    ...
    <?php
     while ($data = $query->fetch()){ ?>
        <tr >
            ...
            <td><a href="form_siswaupdate.php?nis=<?= $data['nis']?>" class="btn btn-primary btn-sm"><ion-icon name="brush"></ion-icon>Edit </a>
                <a href= "hapus_siswa.php?nis=<?= $data['nis'] ?>"class="btn btn-danger btn-sm"><ion-icon name="trash-outline"></ion-icon>Hapus</a>
                <a href= "form_transaksi.php?id_spp=<?= $data['id_spp'] ?>"class="btn btn-danger btn-sm"><ion-icon name="trash-outline"></ion-icon>Bayar</a>
            </td>
        </tr>
        <?php } ?>
    </table>
