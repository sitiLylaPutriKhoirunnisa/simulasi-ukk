<?php
    ...
    $query = $koneksi->query("select * from kelas ");
...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <a href="form_tambahdatakelas.php" class="btn btn-warning">Tambah Data</a>
    ...
    <?php
     while ($data = $query->fetch()){ ?>
        <tr >
            ...
            <td><a href="form_kelasupdate.php?id_kelas=<?= $data['id_kelas']?>" class="btn btn-primary btn-sm"><ion-icon name="brush"></ion-icon>
Edit </a>
            
                <a href= "hapus_kelas.php?id_kelas=<?= $data['id_kelas'] ?>"class="btn btn-danger btn-sm"><ion-icon name="trash-outline"></ion-icon>
Hapus</a>
            </td>
        </tr>
        <?php } ?>
