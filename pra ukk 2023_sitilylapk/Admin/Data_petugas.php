...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <a href="form_tambahpetugas.php" class="btn btn-warning">Tambah Data</a>
    ...
    <?php
     while ($data = $query->fetch()){ ?>
        <tr >
            ...
            <td><a href="form_petugasupdate.php?id_petugas=<?= $data['id_petugas'] ?>" class="btn btn-primary btn-sm"><ion-icon name="brush"></ion-icon>Edit</a>
                <a href= "hapus_petugas.php?id_petugas=<?= $data['id_petugas'] ?>"class="btn btn-danger btn-sm"><ion-icon name="trash-outline"></ion-icon>Hapus</a>
            </td>
        </tr>
        <?php } ?>
    </table>
