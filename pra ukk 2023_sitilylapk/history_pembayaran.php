...
<div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <a href="form_tambahsiswa.php" class="btn btn-warning">Tambah Data</a>
    ...
    <?php
     while ($data = $query->fetch()){ ?>
        <tr >
            ...
            <td><a href="form_siswaupdate.php" class="btn btn-primary btn-sm"><ion-icon name="brush"></ion-icon>Edit </a>
                <a href= "hapus_siswa.php?nis=<?= $data['nis'] ?>"class="btn btn-danger btn-sm"><ion-icon name="trash-outline"></ion-icon>Hapus</a>
            </td>
        </tr>
        <?php } ?>
    </table>
